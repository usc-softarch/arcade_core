...
"%JAVA_HOME%\bin\java" %DEPENDENCYFINDER_OPTS% -classpath "%DEPENDENCYFINDER_HOME%\classes;%DEPENDENCYFINDER_HOME%\lib\DependencyFinder.jar;%DEPENDENCYFINDER_HOME%\lib\guava.jar;%DEPENDENCYFINDER_HOME%\lib\jakarta-oro.jar;%DEPENDENCYFINDER_HOME%\lib\jsr305.jar;%DEPENDENCYFINDER_HOME%\lib\log4j.jar;%CLASSPATH%" com.jeantessier.dependencyfinder.cli.JarJarDiff %DEPENDENCYFINDER_CMD_LINE_ARGS%
