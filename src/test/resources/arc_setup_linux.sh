...
chmod u+x ext-tools/mallet-2.0.7/bin/mallet

./ext-tools/mallet-2.0.7/bin/mallet import-dir --input subject_systems/Struts2/src/struts-2.3.30 --remove-stopwords TRUE --keep-sequence TRUE --output target/test_results/BatchClusteringEngineTest/struts-2.3.30/base/topicmodel.data
...
./ext-tools/mallet-2.0.7/bin/mallet import-dir --input subject_systems/Struts2/src/struts-2.5.2 --remove-stopwords TRUE --keep-sequence TRUE --output target/test_results/BatchClusteringEngineTest/struts-2.5.2/base/topicmodel.data
...
./ext-tools/mallet-2.0.7/bin/mallet import-dir --input subject_systems/httpd/src/httpd-2.4.26 --remove-stopwords TRUE --keep-sequence TRUE --output target/test_results/BatchClusteringEngineTest/httpd-2.4.26/base/topicmodel.data
...
./ext-tools/mallet-2.0.7/bin/mallet import-dir --input subject_systems/httpd/src/httpd-2.3.8 --remove-stopwords TRUE --keep-sequence TRUE --output target/test_results/BatchClusteringEngineTest/httpd-2.3.8/base/topicmodel.data
