...
class BipartiteGraph {
    ...
    public String XOR() {
        ...
        start = augmentPath.get(0).intValue();

        for (int i = 1; i < augmentPath.size(); i++)
        {
            end = augmentPath.get(i).intValue();
    ...
    public boolean findPath(int start) {
        ...
        for (int i = 0; i < adjacentList.get(start).size(); i++) {
            nextPt = adjacentList.get(start).get(i).intValue();
    ...
    public String toString() {
        ...
        for (int i = 0; i < points; i++) {
            ...
            for (int j = 0; j < adjacentList.get(i).size(); j++) {
                int to = adjacentList.get(i).get(j).intValue();
