...
public class Edge 
{
  ...
  /**
   * Creates an edge initialized with the passed parameters as its source,
   * target, type, respectively weight.
   *
   * @param source the node which acts as the source of this object
   * @param target the node which acts as the target of this object
   * @param type the type of this object
  ...
  /**
   * Returns the name of the Node towards which <code>this</code> edge is
   * directed
   * 
   ...
   * 
   * @return type of edge followed by the source's name of this edge followed by
   *         the target's name of this edge
   */
