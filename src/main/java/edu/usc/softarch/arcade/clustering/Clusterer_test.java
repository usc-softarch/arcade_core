...
public class Clusterer_test {
	...
	public static Architecture run(ClusteringAlgorithmType algorithm,
			...
			throws IOException, UnmatchingDocTopicItemsException,
			ExecutionException, InterruptedException {
		Clusterer_test runner = new Clusterer_test(serialCrit, arch, algorithm,
	...
	//region CONTRUCTORS
	public Clusterer_test(SerializationCriterion serializationCriterion,
	...
	public void serialize() throws IOException {
		...
		if (printDots) {
			this.architecture.writeToDotClusters();
			this.architecture.writeToDot();
		}
