...
public class ReflexionMethod {
	private static Logger logger = Logger.getLogger(ReflexionMethod.class);
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Set<Pair<String,String>> convergenceEdges = new LinkedHashSet<>();
		Set<Pair<String,String>> divergenceEdges = new LinkedHashSet<>();
		Set<Pair<String,String>> absentEdges = new LinkedHashSet<>();
		...
		for (DefaultEdge actualEdge : actualGraph.edgeSet()) {
			...
			Pair<String,String> actualPair = new ImmutablePair<>(actualSrc,actualTgt);
		...
		for (DefaultEdge actualEdge : actualGraph.edgeSet()) {
			...
			for (DefaultEdge expectedEdge : expectedGraph.edgeSet()) {
				...
				expectedPair = new ImmutablePair<>(expectedSrc,expectedTgt);
